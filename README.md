...
**Camera and mouse controls.** Three camera modes: *mirror* (frames the character as the webcam frames you), *follow* (full body, pans with you) and *free/orbit*. Dragging or scrolling on the viewport switches to the free camera from wherever the automatic camera was: left-drag rotates, the wheel zooms, right-drag or two fingers pan. Double-click the viewport, click the pill at the bottom, pick a mode in the Stage panel or press `c` to return to the automatic camera.
